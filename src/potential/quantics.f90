...
module quantics_interface_mod
    ...
    contains
        procedure :: initialize => quantics_initialize
        procedure :: update_geometry => quantics_update_geometry
        procedure :: eval => quantics_eval
        !   procedure :: get_nadv => quantics_get_nadv
...
contains
    ...
    subroutine quantics_initialize(self)
        ...
        integer :: ilbl, jlbl, ierr
        logical :: check, chkdvr, chkgrd
        logical :: lerr
    ...
    subroutine shzagreb_run(cstate, en, gra, nadvec, sovec, spinvec, socbas, adt)
